...
The bug tracker utilizes several labels to help organize and identify issues. Here's what they represent and how we use them:

- `browser bug` - Issues that are reported to us, but actually are the result of a browser-specific bug.
- `confirmed` - Issues that have been confirmed with a reduced test case.
- `documentation` - Issues for improving or updating the documentation.
- `examples` - Issues involving the example templates included in the docs.
...
- `gulp` - Issues with the included JavaScript-based Gulpfile, which is used to run all the tests, source files compilation, and more.
...
A good bug report shouldn't leave others needing more
...
Feature requests are welcome. Please take a moment to think whether your idea
...
license your work under the terms of the [ISC License](LICENSE) (if it
...
By contributing your code, you agree to license your contribution under the [ISC License](LICENSE).
